...
%---------------------------------------------------------
  \cventry
    ...
    {MICROLAND ELECTRONICS  \newline \textnormal{A privately owned IT distribution channel partner focused on computer/server components and storage products}} % Organization
    ...
    {Jan. 2016 - PRESENT} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
       ...
       \item {Led revenue growth of 140\% over 7 quarters by building strategic B2B marketing initiatives \newline including incentive programs, sales/ customer events, trainings, digital campaigns}
        ...
        \item {Surpassed daily product sales target by up to \$750K by hosting quarterly “Floor Days,” dedicating \newline 1 day to promote a partner’s single product line, generating buzz and mindshare}
